...
export const submissions: Submission[] = [
  {
    ...
    answers: [
      { questionId: 'q1', answer: 'An object at rest stays at rest and an object in motion stays in motion unless acted upon by an external force.' },
    ...
    feedback: {
      score: 85,
      comments: 'Good understanding of fundamental physics concepts. Could improve explanations of Newton\'s laws with more specific details about force calculations.',
      actionItems: [
  ...
  },
  {
    ...
    feedback: {
      score: 92,
      comments: 'Excellent understanding of chemistry concepts. Your explanations are clear and demonstrate deep knowledge of the subject.',
      actionItems: [
