 ...
 */
export function filterExamsByDateRange(exams: Exam[], startDate: Date, endDate: Date): Exam[] {
 ...
 */
export function calculateScoreDistribution(submissions: Submission[], rangeSize: number = 10) {
